...
<head>
    ...
    <title>wynsher | GitHub Pages</title>
    <meta name="description" content="wynsher's personal page">
    <style>
        body {
        ...
        .container {
            background-color: rgba(230, 198, 187, 0.5);
        ...
        .avatar {
            ...
            height: 100px;
            border-radius: 50%;
            border: 2px solid rgba(230, 198, 187, 0.4);
            margin: 0 auto 20px;
        }
        .social-links {
            display: flex;
...
<body>
    <div class="container">
        <img src="https://cdn.discordapp.com/avatars/1159431835420467221/7067b2ad6431a4d26dd188b09ef24b86.webp" alt="Avatar" class="avatar">
        <h1>wynsher</h1>
        <div class="status">currently doing nothing</div>
        
        <div class="social-links">
            <a href="https://tiktok.com/wynsher" target="_blank" title="TikTok">
            ...
            <a href="https://github.com/wynsher" target="_blank" title="GitHub">
            ...
            <a href="https://roblox.com/users/1085515437/profile" target="_blank" title="Roblox">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0.16 0 23.68 24"><path fill="currentColor" d="M5.164 0L.16 18.928L18.836 24L23.84 5.072Zm8.747 15.354l-5.219-1.417l1.399-5.29l5.22 1.418l-1.4 5.29z"></path></svg>
            </a>
            <a href="https://pinterest.com/wynsher" target="_blank" title="Pinterest">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="-0.01 0 16 16"><path fill="currentColor" d="M8 0a8 8 0 0 0-2.915 15.452c-.07-.633-.134-1.606.027-2.297c.146-.625.938-3.977.938-3.977s-.239-.479-.239-1.187c0-1.113.645-1.943 1.448-1.943c.682 0 1.012.512 1.012 1.127c0 .686-.437 1.712-.663 2.663c-.188.796.4 1.446 1.185 1.446c1.422 0 2.515-1.5 2.515-3.664c0-1.915-1.377-3.254-3.342-3.254c-2.276 0-3.612 1.707-3.612 3.471c0 .688.265 1.425.595 1.826a.24.24 0 0 1 .056.23c-.061.252-.196.796-.222.907c-.035.146-.116.177-.268.107c-1-.465-1.624-1.926-1.624-3.1c0-2.523 1.834-4.84 5.286-4.84c2.775 0 4.932 1.977 4.932 4.62c0 2.757-1.739 4.976-4.151 4.976c-.811 0-1.573-.421-1.834-.919l-.498 1.902c-.181.695-.669 1.566-.995 2.097A8 8 0 1 0 8 0"></path></svg>
            </a>
            <a href="https://youtube.com/@wynsherdev" target="_blank" title="YouTube">
            ...
            <a href="https://instagram.com/wynsherdev" target="_blank" title="Instagram">
            ...
            <a href="https://discord.com/users/1159431835420467221" target="_blank" title="Discord">
            ...
            <a href="https://steamcommunity.com/id/wynsher/" target="_blank" title="Steam">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="2 2 19.97 20"><path fill="currentColor" d="M8.21 17.32L7 16.8a2.13 2.13 0 1 0 1.17-2.93l1.28.53a1.58 1.58 0 0 1-1.22 2.92z"></path><path fill="currentColor" d="M12 2a10 10 0 0 0-10 9.34l5.38 2.21a2.31 2.31 0 0 1 .47-.24A2.62 2.62 0 0 1 9 13.1l2.44-3.56a3.8 3.8 0 1 1 3.8 3.8h-.08l-3.51 2.5a2.77 2.77 0 0 1-5.47.68l-3.77-1.6A10 10 0 1 0 12 2z"></path><path fill="currentColor" d="M17.79 9.5a2.53 2.53 0 1 0-2.53 2.5a2.54 2.54 0 0 0 2.53-2.5zm-4.42 0a1.9 1.9 0 1 1 1.9 1.91a1.9 1.9 0 0 1-1.9-1.92z"></path></svg>
            </a>
        </div>
    </div>
</body>
